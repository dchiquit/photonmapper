...
namespace graphics {
    ...
    public:
        ...
        Color(std::function<float(int)> spd);
        Color(float r, float g, float b);
        Color(float a, float b, float c, ColorSpace cSpace);
        Color(std::array<float, 81> spd);
        Color(const Color& c);
        ...
        Color invGammeCorrected(double gamma) const;
    ...
    private:
        ...
        // 5 nm step over [380, 780]
        // colorMatchXYZ[wavelength(nm)][XYZ]
        typedef std::array<double,3> colorMatchTuple;
        std::array<colorMatchTuple, 81> colorMatchXYZ {{
